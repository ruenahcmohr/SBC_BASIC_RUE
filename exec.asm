...
END:			CALL    SETLIN          ;FIND CURRENT LINE
			...
			JP      WARM            ;"Ready"
;
NEWLIN:			LD      A,+0(IY)        ;A=LINE LENGTH
			LD      BC,#3
			ADD     IY,BC
			OR      A
...
GOTO2:			EXX
			...
			JP      Z,XEQ0
			LD      A,#41
			JR      EERROR2          ;"No such line"
;
;GOSUB line
;
EGOSUB:			CALL    ITEMI           ;LINE NUMBER
...
NEXT1:			LD      HL,#18
			...
			JR      Z,NEXT0
			LD      A,#33
EERROR3:			JP      ERROR           ;"Can't match FOR"
;
;FNname
;N.B. ENTERED WITH A <> TON
;
EFN:			PUSH    AF              ;MAKE SPACE ON STACK
			CALL    PROC1
FNCHK			.EQU     .
;
;PROCname
...
;
EPROC:			PUSH    AF              ;MAKE SPACE ON STACK
			CALL    PROC1
EPROCHK			.EQU     .
PROC1:			CALL    CHECK
			DEC     IY
